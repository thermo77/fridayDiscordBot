Friday Bot Made By Thermo77 :D
This bot allows you to use the !friday command to see how long it is until friday
...
>create a new bot
>copy your bot token in to the string at the bottom at main.js
>open up the terminal and type in node.js
